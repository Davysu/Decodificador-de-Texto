...
const encriptar = () => {
    ...
    const resultadoEncriptar = text.replace(/e/g, 'enter').replace(/i/g, 'imes').replace(/a/g, 'ai')
...
const descriptografar = () => {
    ...
    const resultadoDescriptografar = text.replace(/enter/g, 'e').replace(/imes/g, 'i').replace(/ai/g, 'a')
